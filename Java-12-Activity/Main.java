class Main {
  ...
  void init(){
   ...
   System.out.println(creditCardType("344445"));
   System.out.println(creditCardType("375"));
...
/*
    ...
    6011 or 65 - Discover
    */
String creditCardType(String credit){
  if(credit.substring(0,1).equals("4")){
    return "Visa";
  }
  else if (credit.substring(0,2).equals("34") || credit.substring(0,2).equals("37")){
    return "American Express";
  }
  else if (credit.substring(0,2).equals("36")){
    return "Diner's Club";
  }
  else if (credit.substring(0,2).equals("51") || credit.substring(0,2).equals("55")){
    return "Mastercard";
  }
  else if (credit.substring(0,4).equals("6011") || credit.substring(0,2).equals("65")){
    return "Discover";
  }
  else
    return "not found";
